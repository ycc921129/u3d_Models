...
{
    /// <summary>
    /// LangueConfig(BaseLangue) VOModel
    /// [多语言配置模块表] [L] [_Excel/本地配置表/D_多语言配置模块表_L (动态多语言) .xlsx]
    /// </summary>
    public partial class LangueConfigVOModel : BaseVOModel<LangueConfigVOModel, LangueConfigVO>
    {
        public override string DescName { get { return "_Excel/本地配置表/D_多语言配置模块表_L (动态多语言) .xlsx"; } }
        public override string FileName { get { return "Local"; } }
        public override string BaseVOName { get { return "BaseLangue"; } }
        public override string VOName { get { return "LangueConfig"; } }
        ...
        protected override LangueConfigVO MakeVO()
        {
            LangueConfigVO vo = new LangueConfigVO(this);
            return vo;
        }
    }
}