...
public class BuglyInit : MonoBehaviour
{
	...
	void Awake ()
	{
        ...
        // ODO Required. If you do not need call 'InitWithAppId(string)' to initialize the sdk(may be you has initialized the sdk it associated Android or iOS project),
        // please call this method to enable c# exception handler only.
        BuglyAgent.EnableExceptionHandler ();
        
        // ODO NOT Required. If you need to report extra data with exception, you can set the extra handler
   ...
   // Extra data handler to packet data and report them with exception.
    ...
    {
        // ODO Test log, please do not copy it
        BuglyAgent.PrintLog (LogSeverity.Log, "extra handler");
        
        // ODO Sample code, please do not copy it
