...
namespace MoreMountains.NiceVibrations
{
	...
	public static class MMVibrationManager 
	{
		...
		public static void Vibrate()
        {
			...
			{
                // [修改]
				iOSTriggerHaptics (HapticTypes.MediumImpact, true);
			} 
		}
        ...
        // [修改]
        public static void Haptic(HapticTypes type, bool defaultToRegularVibrate = true)
		{
			if (Android ())
			{
				switch (type)
		...
		/// <param name="type">Type.</param>
        // [修改]
		public static void iOSTriggerHaptics(HapticTypes type, bool defaultToRegularVibrate = true)
		{
			if (!iOS ()) { return; }
