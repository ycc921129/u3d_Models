    ...
    public class GList : GComponent
    {
        ...
        public override void Dispose()
        {
            ...
            if (_virtualListChanged != 0)
                FTimers.inst.Remove(this.RefreshVirtualList);
        ...
        /// 控制动画缓动时间
        /// </summary>
        private float m_animTweenTime = 0f;
        /// <summary>
        /// [DU 修改]
        /// 控制动画缓动时间
        /// </summary>
        public void ScrollToView_UseAnim(int index, bool ani, float animTweenTime)
        {
            if (ani)
            {
                m_animTweenTime = animTweenTime;
            }
            ScrollToView(index, ani, false);
        }
        /// <summary>
        ...
        /// 设置动画缓动时间
        /// </summary>
        private void SetAnimTweenTime(ScrollPane curSorollPane, bool ani)
        {
            if (ani)
            {
                curSorollPane.SetAnimTweenTime(m_animTweenTime);
            }
        }
        ...
        /// 累积更新列表的次数
        /// </summary>
        public int amassUpdateListNum = 0;
        /// <summary>
        /// [Du 修改]
        ...
        public int numItems
        {
            ...
            set
            {
                ...
                else
                {
                    // [Du 修改]
                    amassUpdateListNum++;
                    int currAmassUpdateListNum = amassUpdateListNum;
                    ...
                    if (itemRenderer != null)
                    {
                        for (int i = 0; i < value; i++)
                        {
                            // [Du 修改] 只更新最近一次的列表刷新
                            // [Du 修改] 提前判断下标安全
                            if (currAmassUpdateListNum == amassUpdateListNum)
                            {
                                ...
                                {
                                    LogUtil.LogError("[FGUI-GList]Error Update GList invalid index: " + i);
                                }
                            }
                        }
                    }
        ...
        void SetVirtualListChangedFlag(bool layoutChanged)
        {
            ...
            FTimers.inst.CallLater(RefreshVirtualList);
        }
