...
namespace FairyGUI
{
    ...
    {
        //HACK button修改
        protected Controller _iconController;
        ...
        override public string icon
        {
            ...
            set
            {
                ...
                //HACK BUtton修改 
                if (_iconController != null) _iconController.selectedIndex = value == null ? 1 : 0;  
        ...
        public void FireClick(bool downEffect, bool clickCall = false)
        {
            if (downEffect && _mode == ButtonMode.Common)
            {
                ...
                FTimers.inst.Add(0.1f, 1, (object param) => { SetState(DOWN); });
                FTimers.inst.Add(0.2f, 1,
                    (object param) =>
                    {
                        SetState(UP);
                        if (clickCall)
        ...
        {
            //HACK button修改
            _iconController = GetController("cont_icon");
