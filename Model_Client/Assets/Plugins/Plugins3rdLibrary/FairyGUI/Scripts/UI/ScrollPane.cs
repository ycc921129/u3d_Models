...
namespace FairyGUI
{
    ...
    public class ScrollPane : EventDispatcher
    {
        ...
        /// [DU 修改]
        /// </summary>
        public void SetAnimTweenTime(float animTweenTime)
        {
        ...
        public void Dispose()
        {
            ...
            if (_tweening != 0)
                FTimers.inst.Remove(_tweenUpdateDelegate);
        ...
        void Refresh2()
        {
            if (_aniFlag == 1 && !_dragged)
            {
                ...
                {
                    // [DU 修改]
                    if (m_animTweenTime == 0f)
                    {
                        _tweenDuration = new Vector2(TWEEN_TIME_GO, TWEEN_TIME_GO);
                    }
                    else
                    {
                        _tweenDuration = new Vector2(m_animTweenTime, m_animTweenTime);
                    }
                    //_tweenDuration = new Vector2(TWEEN_TIME_GO, TWEEN_TIME_GO);
                    _tweenStart = _container.xy;
        ...
        void StartTween(int type)
        {
            _tweenTime.Set(0, 0);
            _tweening = type;
            FTimers.inst.AddUpdate(_tweenUpdateDelegate);
