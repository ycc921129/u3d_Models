...
namespace FairyGUI
{
    ...
    {
        // [Du 修改]
        public bool Ex_IsAutoMultiLang { private set; get; }
        // [Du 修改]
        public int Ex_ControllerSelectedIndex { private set; get; }
        ...
        /// [Du 修改]
        /// </summary>
        public void SetText(object setText)
        {
            if (Ex_IsAutoMultiLang)
            {
                Ex_IsAutoMultiLang = false;
            }
