...
namespace FairyGUI
{
    ...
    public class GTween
    {
        ...
        /// [Du 修改]
        /// </summary>
        public static GTweener Ex_ToDoubleLinear(double startValue, double endValue, float duration)
        {
            return TweenManager.CreateTween()._To(startValue, endValue, duration).SetEase(EaseType.Linear).SetIgnoreEngineTimeScale(false);
        }
        #endregion
    }
}