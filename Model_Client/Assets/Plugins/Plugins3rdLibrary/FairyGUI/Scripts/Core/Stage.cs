...
#pragma warning restore 0649
            ...
            : base()
        {
            ...
            FTimers.inst.Add(5, 0, RunTextureCollector);
        ...
        public override void Dispose()
        {
            ...
            FTimers.inst.Remove(RunTextureCollector);
        ...
        // [Du 修改]
        public bool HasTouchMonitor(EventDispatcher target)
        {
            for (int j = 0; j < 5; j++)
            {
                TouchInfo touch = _touches[j];
