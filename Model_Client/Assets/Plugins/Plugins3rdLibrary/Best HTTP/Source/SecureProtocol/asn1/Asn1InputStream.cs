        ...
        : FilterStream
    {
        ...
        */
        ...
        public Asn1Object ReadObject()
        {
            ...
            // ODO There are other tags that may be constructed (e.g. BitString)
            switch (tagNo)
            {
            case Asn1Tags.OctetString:
        ...
        internal virtual DerBitString BuildConstructedBitString(Asn1EncodableVector contentsElements)
        {
            ...
            // ODO Probably ought to be DLBitString
        ...
        internal virtual Asn1OctetString BuildConstructedOctetString(Asn1EncodableVector contentsElements)
        {
            ...
            // ODO Probably ought to be DerOctetString (no DLOctetString available)
            ...
            byte[][]                    tmpBuffers)
        {
            switch (tagNo)
            {
                ...
                case Asn1Tags.ObjectIdentifier:
                    // ODO Ideally only clone if we used a buffer
