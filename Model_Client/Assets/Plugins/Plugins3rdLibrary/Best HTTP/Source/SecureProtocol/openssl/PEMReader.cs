...
//			parsers.Add("PRIVATE KEY", new PrivateKeyParser(provider));
        ...
        */
        ...
        public object ReadObject()
        {
            ...
            // ODO Follow Java build and map to parser objects?
...
//				return ((PemObjectParser)parsers[obj.Type]).ParseObject(obj);
            ...
            switch (obj.Type)
            {
                ...
                // ODO Add back in when tests done, and return type issue resolved
                //case "EC PARAMETERS":
        ...
        * @throws IOException if an I/O error occured
        */
        // ODO Consider returning Asn1.Pkcs.ContentInfo
        ...
        */
            ...
            try
            {
                ...
                switch (type)
                {
                    ...
                    case "DSA":
                    {
                        ...
                        // ODO Create an ASN1 object somewhere for this?
                    ...
                    case "EC":
                    {
                        ...
                        // ODO Are the keys returned here ECDSA, as Java version forces?
                        ...
                        if (pubKey != null)
                        {
                            ...
                            // DO Are the keys returned here ECDSA, as Java version forces?
        ...
        // ODO Add an equivalent class for ECNamedCurveParameterSpec?
...
//		}
        ...
        private static X9ECParameters GetCurveParameters(
            string name)
        {
            // ODO ECGost3410NamedCurves support (returns ECDomainParameters though)
