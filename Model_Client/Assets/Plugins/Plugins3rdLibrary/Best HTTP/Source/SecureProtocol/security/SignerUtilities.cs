...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Security
{
    ...
    public sealed class SignerUtilities
    {
        ...
        // ODO Don't really want to support this
            ...
            string algorithm)
        {
            ...
            {
                // ODO The Sha1Digest here is a default. In JCE version, the actual digest
            ...
            string	digestName)
        {
            ...
            // ODO Is it possible for the MGF hash alg to be different from the PSS one?
            ...
            string algorithm)
        {
            ...
            {
                // ODO Add support for other parameter settings
