...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC
{
        ...
        : AbstractFpFieldElement
    {
        ...
        {
            // ODO Modular inversion can be faster for a (Generalized) Mersenne Prime.
        ...
        public override ECFieldElement Sqrt()
        {
            ...
            if (q.TestBit(2)) // q == 8m + 5
            {
                ...
                // ODO This is constant and could be precomputed
        ...
        private BigInteger[] LucasSequence(
            ...
            BigInteger	k)
        {
            // ODO Research and apply "common-multiplicand multiplication here"
