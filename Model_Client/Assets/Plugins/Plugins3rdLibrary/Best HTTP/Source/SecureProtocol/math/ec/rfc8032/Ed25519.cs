...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC.Rfc8032
{
    public abstract class Ed25519
    {
        ...
        // ODO[ed25519] Convert to PointPrecomp
        ...
        {
            // ODO This method is currently hardcoded to 4-bit windows and 8 precomputed points
        ...
        public static void Precompute()
        {
            lock (precompLock)
            {
                ...
                for (int b = 0; b < PrecompBlocks; ++b)
                {
                    ...
                    // ODO[ed25519] A single batch inversion across all blocks?
                    {
                        int[] u = F.Create();
