    ...
    public class ECAlgorithms
    {
        ...
        */
        ...
        internal static ECPoint ImplShamirsTrickJsf(ECPoint P, BigInteger k, ECPoint Q, BigInteger l)
        {
            ...
            // ODO conjugate co-Z addition (ZADDC) can return both of these
        ...
        private static ECPoint ImplShamirsTrickFixedPoint(ECPoint p, BigInteger k, ECPoint q, BigInteger l)
        {
            ...
            {
                /*
                 * ODO The comb works best when the scalars are less than the (possibly unknown) order.
            ...
            // ODO This shouldn't normally happen, but a better "solution" is desirable anyway
            if (widthP != widthQ)
            {
