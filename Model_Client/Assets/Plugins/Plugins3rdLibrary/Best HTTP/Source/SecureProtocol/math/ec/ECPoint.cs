...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC
{
    ...
    public abstract class ECPoint
    {
        ...
        protected virtual bool SatisfiesOrder()
        {
            ...
            // ODO Require order to be available for all curves
        ...
        public virtual ECPoint Normalize()
        {
            ...
            switch (this.CurveCoordinateSystem)
            {
                ...
                default:
                {
                     ...
                     */
                    // ODO Add CryptoServicesRegistrar class and use here
        ...
        public virtual bool Equals(ECPoint other)
        {
            ...
            {
                // ODO Consider just requiring already normalized, to avoid silent performance degradation

                ECPoint[] points = new ECPoint[] { this, c1.ImportPoint(p2) };

                // ODO This is a little strong, really only requires coZNormalizeAll to get Zs equal
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            switch (coord)
            {
                ...
                case ECCurve.COORD_JACOBIAN_MODIFIED:
                {
                    ...
                    {
                        // ODO Make this available as public method coZAdd?
                    ...
                    {
                        // ODO If the result will only be used in a subsequent addition, we don't need W3
        ...
        public override ECPoint Twice()
        {
            ...
            switch (coord)
            {
                ...
                case ECCurve.COORD_HOMOGENEOUS:
                {
                    ...
                    // ODO Optimize for small negative a4 and -3
            ...
            if (coord == ECCurve.COORD_LAMBDA_PROJECTIVE)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        // ODO If sqrt(b) is precomputed this can be simplified to a single square
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            switch (coord)
            {
                ...
                case ECCurve.COORD_LAMBDA_PROJECTIVE:
                {
                    ...
                    if (X2.IsZero)
                    {
                        // ODO This can probably be optimized quite a bit
            ...
            switch (coord)
            {
                ...
                case ECCurve.COORD_LAMBDA_PROJECTIVE:
                {
                    ...
                    if (b.BitLength < (curve.FieldSize >> 1))
                    {
                        ...
                        {
                            // ODO Can be calculated with one square if we pre-compute sqrt(b)
