...
//		};
		...
		// ODO Create named constants for all of these
		...
		*/
		...
		public void AddKekRecipient(
			string			keyAlgorithm, // ODO Remove need for this parameter
			KeyParameter	key,
			byte[]			keyIdentifier)
		{
			...
			byte[]	encKeyBytes)
		{
			...
			try
			{
				if (encryptionOid.Equals(RC2Cbc))
				{
					...
					// ODO Is this detailed repeat of Java version really necessary?
