...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls.Crypto.Impl.BC
{
        ...
        : AbstractTlsCrypto
    {
        ...
        {
            // ODO[RFC 8422] Revisit the need to buffer the handshake for "Intrinsic" hash signatures
        ...
        public override bool HasCryptoSignatureAlgorithm(int cryptoSignatureAlgorithm)
        {
            ...
            // ODO[draft-smyshlyaev-tls12-gost-suites-10]
        ...
        public override TlsSecret CreateSecret(byte[] data)
        {
            ...
            {
                // ODO[tls-ops] Add this after checking all callers
                //if (data != null)
                //{
        ...
        {
            // ODO Consider allowing custom configuration of multiplier
