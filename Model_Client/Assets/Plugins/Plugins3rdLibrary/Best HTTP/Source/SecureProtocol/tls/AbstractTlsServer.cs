...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : AbstractTlsPeer, TlsServer
    {
        ...
        protected virtual bool IsSelectableCipherSuite(int cipherSuite, int availCurveBits, int availFiniteFieldBits,
            IList sigAlgs)
        {
            // ODO[tls13] The version check should be separated out (eventually select ciphersuite before version)
        ...
        public virtual void ProcessClientExtensions(IDictionary clientExtensions)
        {
            ...
            if (null != clientExtensions)
            {
                ...
                // ODO[tls13] Don't need these if we have negotiated (D)TLS 1.3+
                {
        ...
        {
            // ODO[tls13] The rest of this class assumes all named groups are supported
