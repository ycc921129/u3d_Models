...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : TlsCloseable
    {
        ...
        protected virtual void HandleAlertWarningMessage(short alertDescription)
        {
            ...
            {
                // ODO[reneg] Give peer the option to tolerate this
                throw new TlsFatalAlert(AlertDescription.handshake_failure);
            }
            }
        }
        ...
        protected virtual void HandleFailure()
        {
             ...
             */
            // ODO This isn't quite in the right place. Also, as of TLS 1.1 the above is obsolete.
            InvalidateSession();
        ...
        {
            // ODO: check whether renegotiation is enabled or not and call BeginHandshake/RefuseRenegotiation accordingly.
            BeginHandshake(true);
        }
        ...
        protected virtual void CompleteHandshake()
        {
            try
            {
                ...
                // ODO Prefer to set to null, but would need guards elsewhere
                this.m_handshakeHash = new DeferredHash(context);
        ...
        {
            // ODO[tls13] This is interesting enough to notify the TlsPeer for possible logging/vetting
        ...
        {
            /*
             * ODO[tls13] We are currently allowing any extensions to appear in ClientHello. It is
