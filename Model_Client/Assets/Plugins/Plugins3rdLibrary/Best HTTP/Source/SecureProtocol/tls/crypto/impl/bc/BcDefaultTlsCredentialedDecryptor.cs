...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls.Crypto.Impl.BC
{
        ...
        : TlsCredentialedDecryptor
    {
        ...
        {
            // ODO Keep only the decryption itself here - move error handling outside 
            return SafeDecryptPreMasterSecret(cryptoParams, (RsaKeyParameters)m_privateKey, ciphertext);
        }

        /*
         * ODO[tls-ops] Probably need to make RSA encryption/decryption into TlsCrypto functions so
            ...
            RsaKeyParameters rsaServerPrivateKey, byte[] encryptedPreMasterSecret)
        {
            ...
            // ODO Provide as configuration option?
