...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    internal class DtlsReliableHandshake
    {
        ...
        {
            // ODO Support the possibility of a fragmented ClientHello datagram
            ...
            // ODO Consider stricter HelloVerifyRequest-related checks
        ...
        {
            /*
             * ODO[DTLS] implementations SHOULD back off handshake packet size during the
             * retransmit backoff.
             */
        ...
        private void CheckInboundFlight()
        {
            foreach (int key in m_currentInboundFlight.Keys)
            {
                ...
                {
                    // ODO Should this be considered an error?
                }
            }
        }
        ...
        private Message UpdateHandshakeMessagesDigest(Message message)
        {
            ...
            // ODO[dtls13] Not included in the transcript for (D)TLS 1.3+
        ...
        private void WriteMessage(Message message)
        {
            ...
            // ODO Support a higher minimum fragment size?
            if (fragmentLimit < 1)
            {
                // ODO Should we be throwing an exception here?
