...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
    ...
    public sealed class CertificateRequest
    {
        ...
        // ODO[tls13] Prefer to manage the certificateRequestContext internally only? 
        /// <exception cref="IOException"/>
        ...
        {
            /*
             * ODO[tls13] Removed certificateTypes, added certificate_request_context, added extensions
        ...
        public void Encode(TlsContext context, Stream output)
        {
            ...
            if (isTlsV12)
            {
                // ODO Check whether SignatureAlgorithm.anonymous is allowed here
        ...
        public static CertificateRequest Parse(TlsContext context, Stream input)
        {
            ...
            if (isTlsV13)
            {
                ...
                /*
                 * ODO[tls13] required: signature_algorithms; optional: status_request,
