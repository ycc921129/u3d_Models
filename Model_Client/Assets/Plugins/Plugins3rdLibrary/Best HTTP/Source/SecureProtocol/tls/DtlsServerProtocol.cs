        ...
        : DtlsProtocol
    {
            ...
            DtlsRequest request)
        {
...

            {
                ...
                // ODO[dtls13] Ideally, move this into GenerateServerHello once legacy_record_version clarified
                {
            ...
            // Server certificate
            {
                ...
                // ODO[RFC 3546] Check whether empty certificates is possible, allowed, or excludes CertificateStatus
            ...
            {
               /*
                * ODO[new_session_ticket] Check the server-side rules regarding the session ID, since the client
        ...
        internal virtual byte[] GenerateServerHello(ServerHandshakeState state, DtlsRecordLayer recordLayer)
        {
            ...
            ProtocolVersion server_version = state.server.GetServerVersion();
            {
                ...
                // ODO[dtls13] Read draft/RFC for guidance on the legacy_record_version field
        ...
        {
            // DO Read RFCs for guidance on the expected record layer version number
            ...
            /*
             * ODO[resumption] Check RFC 7627 5.4. for required behaviour 
             */
