...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Tls
{
        ...
        : DtlsProtocol
    {
        ...
        internal virtual DtlsTransport ClientHandshake(ClientHandshakeState state, DtlsRecordLayer recordLayer)
        {
            ...
            // ODO Consider stricter HelloVerifyRequest protocol
            ...
            state.sessionParameters = new SessionParameters.Builder()
                ...
                // ODO Consider filtering extensions that aren't relevant to resumed sessions
        ...
        protected virtual void ProcessCertificateStatus(ClientHandshakeState state, byte[] body)
        {
            ...
            // DO[tls13] Ensure this cannot happen for (D)TLS1.3+
        ...
        protected virtual byte[] ProcessHelloVerifyRequest(ClientHandshakeState state, byte[] body)
        {
            ...
            // ODO Seems this behaviour is not yet in line with OpenSSL for DTLS 1.2
        ...
        protected virtual void ProcessServerHello(ClientHandshakeState state, byte[] body)
        {
            ...
            // ODO[dtls13] Check supported_version extension for negotiated version
            ...
            /*
             * ODO RFC 3546 2.3 If [...] the older session is resumed, then the server MUST ignore
