...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Pkcs
{
    public class Pkcs12Store
    {
        ...
        protected virtual void LoadKeyBag(PrivateKeyInfo privKeyInfo, Asn1Set bagAttributes)
        {
            ...
            if (bagAttributes != null)
            {
                foreach (Asn1Sequence sq in bagAttributes)
                {
                    ...
                    if (attrSet.Count > 0)
                    {
                        // ODO We should be adding all attributes in the set
                        attr = attrSet[0];

                        // ODO We might want to "merge" attribute sets with
                        ...
                        if (aOid.Equals(PkcsObjectIdentifiers.Pkcs9AtFriendlyName))
                        {
                            ...
                            // ODO Do these in a separate loop, just collect aliases here
                            keys[alias] = keyEntry;
                        }
            ...
            if (localId != null)
            {
                ...
                {
                    // ODO There may have been more than one alias
                    localIds[alias] = name;
                }
            }
            else
        ...
        public int Count
        {
            // ODO Seems a little inefficient
