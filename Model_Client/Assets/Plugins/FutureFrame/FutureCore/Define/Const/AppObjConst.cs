...
namespace FutureCore
{
    ...
    {
        public const string FutureFrameGoName = "[FutureFrame]";
        public static GameObject FutureFrameGo;

        public const string LauncherGoName = "[Launcher]";
        public static GameObject LauncherGo;
        ...
        public const string PlatformOS = "[PlatformOS]";
        public static GameObject PlatformOSGo;
        public const string Channel = "[Channel]";
        public static GameObject ChannelGo;
        ...
        public const string SingletonGoName = "[Singleton]";
        public static GameObject SingletonGo;

        public const string WorldSpaceGoName = "[WorldSpace]";
        ...
        public const string GamePlayGoName = "[GamePlay]";
