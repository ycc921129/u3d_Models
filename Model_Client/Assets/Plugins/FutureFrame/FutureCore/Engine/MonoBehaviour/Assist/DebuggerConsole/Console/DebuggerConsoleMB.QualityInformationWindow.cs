        ...
        private sealed class QualityInformationWindow : ScrollableDebuggerWindowBase
        {
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Async Upload Time Slice", TextSbUtil.Format("{0} ms", QualitySettings.asyncUploadTimeSlice.ToString()));
                    DrawItem("Async Upload Buffer Size", TextSbUtil.Format("{0} MB", QualitySettings.asyncUploadBufferSize.ToString()));
