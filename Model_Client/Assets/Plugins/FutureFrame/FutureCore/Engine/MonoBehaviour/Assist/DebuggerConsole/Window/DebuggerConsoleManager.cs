...
namespace FutureCore.FC_Debuger
{
    ...
    {
        private readonly DebuggerConsoleWindowGroup m_DebuggerWindowRoot;
        private bool m_ActiveWindow;

        /// <summary>
        /// 初始化调试器管理器的新实例。
        /// </summary>
        public DebuggerConsoleManager()
        {
            m_DebuggerWindowRoot = new DebuggerConsoleWindowGroup();
        ...
        /// 调试器窗口根结点。
        /// </summary>
        public IDebuggerConsoleWindowGroup DebuggerWindowRoot
        {
            get
            {
