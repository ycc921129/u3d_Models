...
namespace FutureCore.FC_Debuger
{
    ...
    [AddComponentMenu("[FC 组件]/调试控制台组件")]
    public sealed partial class DebuggerConsoleMB : MonoBehaviour
    {
        /// <summary>
        /// 默认调试器漂浮框大小。
        /// </summary>
        internal static readonly Rect DefaultIconRect = new Rect(10f, 10f, 40f, 30f);

        /// <summary>
        /// 默认调试器窗口大小。
        /// </summary>
        internal static readonly Rect DefaultWindowRect = new Rect(10f, 10f, 450, 650f);
        ...
        public static DebuggerConsoleMB Debugger;

        private DebuggerConsoleManager m_DebuggerManager = null;
        ...
        [SerializeField]
        private DebuggerConsoleActiveWindowType m_ActiveWindow = DebuggerConsoleActiveWindowType.AlwaysOpen;
        ...
        private GMFrameWindow m_gmFrameWindow = new GMFrameWindow();
        private GMLogicWindow m_gmLogicWindow = new GMLogicWindow();
        private GMGameWindow m_gmGameWindow = new GMGameWindow();

        private FpsCounter m_FpsCounter = null;
        private ObjectPool<LogNode> logNodeObjectPool = new ObjectPool<LogNode>();

        public const string Key_DebuggerConsoleMB_Width = "Key_DebuggerConsoleMB_Width";
        public const string Key_DebuggerConsoleMB_Height = "Key_DebuggerConsoleMB_Height";
        public const string Key_DebuggerConsoleMB_WindowScale = "Key_DebuggerConsoleMB_WindowScale";
        ...
        public float WindowScale
        {
            ...
            {
                m_WindowScale = value;
                PlayerPrefs.SetFloat(Key_DebuggerConsoleMB_WindowScale, m_WindowScale);
            }
        }
        ...
        private void Awake()
        {
            ...
            m_DebuggerManager = new DebuggerConsoleManager();
            ActiveWindow = true;
        ...
        private void Start()
        {
            ...
            RegisterDebuggerWindow("GM/Frame", m_gmFrameWindow);
            RegisterDebuggerWindow("GM/Logic", m_gmLogicWindow);
            RegisterDebuggerWindow("GM/Game", m_gmGameWindow);
        ...
        private void OnGUI()
        {
            ...
            if (m_ShowFullWindow)
            {
                m_WindowRect = GUILayout.Window(0, m_WindowRect, DrawWindow, "<b>FutureFrame Debugger</b>");
            }
            else
            {
        ...
        public void RegisterDebuggerWindow(string path, IDebuggerConsoleWindow debuggerWindow, params object[] args)
        {
        ...
        public IDebuggerConsoleWindow GetDebuggerWindow(string path)
        {
        ...
        /// 设置是否全屏显示
        /// </summary>
        public void SetIsShowFullWindow(bool value)
        {
            m_ShowFullWindow = value;
        }
        ...
        private void DrawDebuggerWindowGroup(IDebuggerConsoleWindowGroup debuggerWindowGroup)
        {
            ...
            {
                names.Add(TextSbUtil.Format("<b>{0}</b>", debuggerWindowNames[i]));
            }
            ...
            IDebuggerConsoleWindowGroup subDebuggerWindowGroup = debuggerWindowGroup.SelectedWindow as IDebuggerConsoleWindowGroup;
        ...
        private void DrawDebuggerWindowIcon(int windowId)
        {
            ...
            string title = TextSbUtil.Format("<color=#{0}{1}{2}{3}><b>FPS: {4}</b></color>", color.r.ToString("x2"), color.g.ToString("x2"), color.b.ToString("x2"), color.a.ToString("x2"), m_FpsCounter.CurrentFps.ToString("F2"));
            if (GUILayout.Button(title, GUILayout.Width(80f), GUILayout.Height(30f)))
            {
