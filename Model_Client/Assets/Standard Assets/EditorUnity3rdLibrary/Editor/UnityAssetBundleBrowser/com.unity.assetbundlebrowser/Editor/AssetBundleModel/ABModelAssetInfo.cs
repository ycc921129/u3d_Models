    ...
    internal class AssetInfo
    {
        ...
        internal string fullAssetName
        {
            ...
            set
            {
                ...
                //ODO - maybe there's a way to ask the AssetDatabase for this size info.
        ...
        internal IEnumerable<MessageSystem.Message> GetMessages()
        {
            ...
            {
                //ODO - refine the parent list to only include those in the current asset list
        ...
        {
            //ODO - not sure this refreshes enough. need to build tests around that.
