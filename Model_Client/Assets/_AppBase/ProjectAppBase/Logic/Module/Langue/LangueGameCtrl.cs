...
namespace ProjectApp
{
    ...
    /// 国际化接口
    /// </summary>
    public static class I18N_Game
    {
        public static bool IsUse()
        {
            return LangueGameCtrl.Instance.IsUse();
        }

        public static string Get(int id)
        {
            return LangueGameCtrl.Instance.Get(id);
        }

        public static string Get(int id, string rawText)
        {
            return LangueGameCtrl.Instance.Get(id, rawText);
        }

        public static string Get(string key)
        {
            return LangueGameCtrl.Instance.Get(key);
        }

        public static string Get(string key, string rawText)
        {
            return LangueGameCtrl.Instance.Get(key, rawText);
        }
    }
    ...
    /// 动态多语言控制器
    /// </summary>
    public class LangueGameCtrl : LangueCtrl
    {
        public static new LangueGameCtrl Instance { get; private set; }
        ...
        {
            langueVOModel = LangueGameVOModel.Instance;
        }
    }
}