...
namespace ProjectApp
{
    ...
    {
        public override int SceneIdx { get { return SceneConst.LobbyIdx; } }
        public override int PreLoadId { get { return PreLoadIdConst.LobbyScene; } }
        ...
        protected override void OnEnter()
        {
            ...
            App.SetLoadingUI("加载大厅", 0, AppConst.IsLoadingDelay);
        }
        ...
        {
            LogUtil.Log("[LobbyScene]ShowScene");
        }
