...
{
	public class SceneAssetsCheckWindow : EditorWindow
	{
		#region 定义
		...
		[MenuItem("[FC Toolkit]/Check/场景资源检查窗口", false, 4)]
		private static void Init()
		{
			SceneAssetsCheckWindow window = GetWindow<SceneAssetsCheckWindow>("场景资源检查窗口");
		...
		private void OnGUI()
		{
			...
			if (GUILayout.Button("检查场景资源", GUILayout.Width(80), GUILayout.Height(25)))
				CheckResources();
			GUILayout.Space(5);
