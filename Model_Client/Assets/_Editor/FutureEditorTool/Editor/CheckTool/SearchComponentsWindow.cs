...
{
    public class SearchComponentsWindow : EditorWindow
    {
        [MenuItem("[FC Toolkit]/Check/搜索组件窗口", false, 5)]
        private static void Init()
        {
            SearchComponentsWindow window = (SearchComponentsWindow)GetWindow(typeof(SearchComponentsWindow));
            window.Show();
