...
namespace FutureEditor
{
    public class VirtualFolderTreeView : TreeView
    {
        ...
        public Action<VirtualFolderInfo, Rect, TreeView> onGUIRowCallback { get; set; }
        ...
        private const string kGenericDragId = "GenericDragColumnDragging";
        private const string kIsFolderGenericData = "IsFolder";
